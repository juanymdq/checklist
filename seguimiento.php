...
<head>
    ...
    <style>
        #cont{
            margin: 20px 100px 0px 250px;/*FIREFOX*/
            width: 700px;
            height: 400px;
        ...
        function ver_check(){
           ...
           //obtiene la fecha hasta
            ...
            if(hstr == ''){
                ...
                if(sval == 'todos'){
                    window.location.href = 'seguimiento_excel.php?usuario=todos&fd='+fdesde+'&fh='+fhasta+'&nuser=todos';
                }else{
                    window.location.href = 'seguimiento_excel.php?usuario='+sval+'&fd='+fdesde+'&fh='+fhasta+'&nuser='+val_aSel;
                }
            }
        }   
...
<div id="cont">
    <form id="form1" name="form1" method="post" action="buscar_hoja.php">
        ...
        <div>
            <table id="t_cab">
                <tr>
                    <td colspan="2" id="td_cab">LOG DE OPERACIONES</td>
                </tr>  
            </table>
            <table id="t_user">  
                <tr>
                ...
                <tr>
                    <td colspan="4" id="b_horas"><input type="button" value="GENERAR LOG" onclick="ver_check()" /></td>
                </tr>
            </table>    
        </div>       
